...
class NeverCacheUserAgents extends AbstractDeactivateableField
{
    public function registerCallbacks(): void
    {
        add_filter('rocket_cache_reject_ua', [$this, 'mergeSettings']);
        add_filter('get_rocket_option_cache_reject_ua', [$this, 'mergeSettings']);
