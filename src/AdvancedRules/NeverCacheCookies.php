...
class NeverCacheCookies extends AbstractDeactivateableField
{
    public function registerCallbacks(): void
    {
        add_filter('rocket_cache_reject_cookies', [$this, 'mergeSettings']);
        add_filter('get_rocket_option_cache_reject_cookies', [$this, 'mergeSettings']);
