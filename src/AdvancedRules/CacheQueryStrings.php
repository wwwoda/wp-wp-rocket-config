...
class CacheQueryStrings extends AbstractDeactivateableField
{
    public function registerCallbacks(): void
    {
        add_filter('rocket_cache_query_strings', [$this, 'mergeSettings']);
        add_filter('get_rocket_option_cache_query_strings', [$this, 'mergeSettings']);
