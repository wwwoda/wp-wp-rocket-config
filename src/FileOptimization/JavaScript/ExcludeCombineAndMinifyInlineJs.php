...
class ExcludeCombineAndMinifyInlineJs extends AbstractDeactivateableField
{
    public function registerCallbacks(): void
    {
        add_filter('rocket_exclude_js', [$this, 'mergeSettings']);
        add_filter('get_rocket_option_exclude_inline_js', [$this, 'mergeSettings']);
